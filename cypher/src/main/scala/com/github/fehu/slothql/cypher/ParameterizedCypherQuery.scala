package com.github.fehu.slothql.cypher
    ...
    f match {
      case Function(params, body) =>
        val (paramTrees, recTpes) = params.map{ p =>
          ...
          val argTree =
            q"""
              _root_.com.github.fehu.slothql.cypher.CypherFragment.Expr.Param[$tpe](
                ${p.name.decodedName.toString},
                _root_.com.github.fehu.slothql.cypher.CypherStatement.LiftValue[$tpe]
              )
            """
        ...
        q"""
          _root_.com.github.fehu.slothql.cypher.ParameterizedCypherQuery.Internal.create[$recTpe, $retType](
            $f(..$paramTrees)
          ): _root_.com.github.fehu.slothql.cypher.ParameterizedCypherQuery[$recTpe, $retType]
         """
      case _ =>
