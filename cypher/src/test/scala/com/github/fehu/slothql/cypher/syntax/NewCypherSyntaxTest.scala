...
import com.github.fehu.slothql.cypher.{ CypherFragment, CypherStatement }
...
//        """value asString is not a member of com\.github\.fehu\.slothql\.cypher\.CypherFragment\.Expr\.MapKey\[List\[Int\]\]"""
//      )
