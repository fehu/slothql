...
class TransactorTracingMacros(val c: whitebox.Context) {
  ...
  protected def bodyHeader: List[Tree] = List(
    ...
    q"import _root_.com.github.fehu.slothql.cypher.CypherTransactor.Operation",
    q"import _root_.com.github.fehu.slothql.cypher.CypherStatement.Prepared"
  )
  ...
  protected def reportSummaryImpl(F: Tree, wrap: Tree) = {
    val parent = tq"_root_.com.github.fehu.slothql.neo4j.TransactorTracing.SummaryReport[$F]"
  ...
  private object Msg {
    ...
    def unexpectedSetup = "Unexpected tree. Expecting direct call to `com.github.fehu.slothql.neo4j.TransactorTracing.setup` function."
  ...
  protected def lostSpanFixesParent(F: Tree) = tq"_root_.com.github.fehu.slothql.neo4j.TransactorTracing.LostSpanFixes[$F]"
  ...
  private lazy val TransactorType = rootMirror.staticClass("com.github.fehu.slothql.neo4j.Neo4jCypherTransactor").typeSignature
}
